	...
	<Dialog.Content>
		<Dialog.Header>
			<Dialog.Title class="flex items-center justify-between">
				...
				<Button variant="outline" onclick={() => openYtCookiesDialog()} class="ml-auto">
					Set Cookies
				</Button>
			</Dialog.Title>
			...
			<form onsubmit={handleSubmit} class="grid grid-cols-[auto_7rem] items-end">
				<div class="gap-4 py-4 grid">
					<div class="gap-2 grid">
						...
						<Input id="url" bind:value={url} placeholder="https://www.youtube.com/watch?v=..." />
						{#if errorMessage}
				...
				<Dialog.Footer class="py-4">
					<Button type="submit" class="gap-2">Add Song</Button>
				</Dialog.Footer>
			</form>
